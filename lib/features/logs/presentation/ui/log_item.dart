...
class MobileLogItem extends StatelessWidget {
  ...
  const MobileLogItem({super.key, required this.item, required this.onRemove,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          MobileStatusDropDown(
                              item: item, updateStatus: updateStatus),
                        ],
                      ),
...
class LogItem extends StatelessWidget {
  ...
  const LogItem({super.key, required this.item, required this.onRemove,
    required this.updateStatus});
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 8),
                StateToggle(
                    item: item, onRemove: onRemove, updateStatus: updateStatus),
              ],
            ),
          ),
        ),
...
class StateToggle extends ConsumerWidget {
  ...
  const StateToggle(
      {super.key, required this.item, required this.onRemove, required this.updateStatus});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 4),
        CloseButton(id: item.id ?? -1, onPressed: (id) {
          if (id != -1) {
            onRemove(id);
          }
        },),
...
class CloseButton extends ConsumerWidget {
  ...
  const CloseButton({super.key, required this.id, required this.onPressed});
...
class MobileStatusDropDown extends ConsumerWidget {
  ...
  const MobileStatusDropDown(
      {super.key, required this.item, required this.updateStatus});
